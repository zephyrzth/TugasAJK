...
<head>
    ...
    <title>{{ config('app.name', 'Web AJK') }}</title>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_widget_area">
                            ...
                            <p style="color:#FFFFFF">Web ini dibuat oleh Anargya Widyadhana untuk memenuhi tugas tes masuk AJK</p>
                            <br><br>
                            </div>
                        </div>
                    </div>
